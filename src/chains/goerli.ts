import { Chain, goerli as viemGoerli } from 'viem/chains'
...
export const goerli = {
  ...
  contracts: {
    ...
    optimismSystemConfig: {
      84531: {
        address: '0xb15eea247eCE011C68a614e4a77AD648ff495bc1',
      },
    },
    optimismSystemDictator: {
      84531: {
        address: '0x3A2b271C49e673DEF1561c7fF159b99a7c5801b8',
      },
    },
  },
} satisfies Chain
